---
title: "Session 5 - Visulaisierung & Recap"
...
```{r, echo=TRUE, warning=FALSE, message=FALSE}
nrow(gtdb[ gtdb$iyear == 2009 & ( gtdb$targtype1_txt == "Educational Institution" | gtdb$natlty1_txt == "East Timor"), ])
```
...
1. In dem Datensatz hat sich bei *atacktype1_txt* bei manchen Variablen ein Fehler eingeschlichen. Ändere die numerischen Werte in ihre String-Repräsentation. Erstelle nun einen neuen Barplot. 
