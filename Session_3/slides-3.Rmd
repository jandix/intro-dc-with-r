...
## 5. Aufgaben
1. Inspizieren Sie die unterschiedlichen Dateien des Ordners `./Data/Session_3`.
2. Laden Sie alle Dateien in R und speichern Sie sie in unterschiedlichen, aussagekräftigen Variablen.
3. Schauen Sie sich die Variablen mit Hilfe des Befehls `View()` an.
4. Fügen Sie die vier Teildatensätze sinnvoll zusammen. Überlegen Sie sorgfältig, welche der kennengelernten  Funktionen Sie dabei benötigen. 
5. Speichern Sie den finalen Datensatz im rds-Format in Ihrem Projektordner. 
