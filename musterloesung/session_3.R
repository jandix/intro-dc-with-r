...
gtdb_1998_2014 <- read_excel("data/gtdb_1998-2014.xlsx")
View(gtdb_1998_2014)

# gtdb_2015.tsv laden
gtdb_2015 <- read_delim("data/gtdb_2015.tsv", 
                        "\t", escape_double = FALSE, trim_ws = TRUE)
View(gtdb_2015)

# gtdb_2016.csv laden
gtdb_2016 <- read_delim("data/gtdb_2016.csv", 
...
load("data/gtdb_coordinates.RData")
...
gtdb <- rbind(gtdb_1998_2014, gtdb_2015, gtdb_2016)
